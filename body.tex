...
cases, we were able to determine what the user's behavior during that
...
While detecting cleartext application-level data is an important first step in understanding
